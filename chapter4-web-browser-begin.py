...
class Browser(QWidget):
    ...
    def __init__(self):
        ...
        self.go_btn.setMaximumSize(25,20)

        # create favorites
        self.favorites = QComboBox(self)
        self.favorites.addItems(["http://www.google.com",
                                 "http://www.raspberrypi.org",
                                 "http://www.amazon.com"])
        self.favorites.activated.connect(self.favorite_selected)
        self.favorites.setMinimumSize(200,20)
        self.favorites.setMaximumSize(300,20)

        # create search box
        self.search_box = QLineEdit(self)
        self.search_box.setMinimumSize(200,20)
        self.search_box.setMaximumSize(300,200)
        ...
        self.menu_bar.addWidget(self.favorites)
        self.menu_bar.addStretch()
    ...
    def favorite_selected(self):
        self.webview.load(self.favorites.currentText())

    def zoom_changed(self):
        self.webview.setZoomFactor(self.zoom_slider.value()/10)

    def search_btn_clicked(self):
        self.webview.load("http://www.google.com/search?q="
...
window.setWindowTitle("Custom Python Browser")        
window.show()
